...
use Mail;
use Carbon\Carbon;
use App\Http\Requests\Staff\User\ResetPassword as ResetPasswordRequest;

class ResetPasswordController extends Controller
{
    public function requestForm()
    {
        return view('staff.reset_password.request_form');
    }
    ...
    public function request(ResetPasswordRequest\RequestRequest $request)
    {
        ...
        return view('staff.reset_password.request'); 
    }
    ...
    public function resetForm(Request $request, $token)
    {
        ...
        return view('staff.reset_password.reset_form')->withUser($user);
    }
    ...
    public function reset(ResetPasswordRequest\ResetRequest $request)
    {
        ...
        return redirect()->route('staff.signin')->with(
            'info',
            'パスワードを再設定しました。'
        );
    }
